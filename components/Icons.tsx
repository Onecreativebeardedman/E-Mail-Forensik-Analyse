...
export const BeakerIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.087c0-.66.539-1.198 1.207-1.198h.001a1.2 1.2 0 011.206 1.198v2.263a1.2 1.2 0 001.206 1.198h.001a1.2 1.2 0 011.207 1.198v5.485a1.199 1.199 0 01-1.206 1.198h-.001a1.2 1.2 0 01-1.207-1.198v-2.263a1.2 1.2 0 00-1.206-1.198h-.001a1.2 1.2 0 01-1.207-1.198V6.087zM5.625 6.087c0-.66.539-1.198 1.207-1.198h.001a1.2 1.2 0 011.206 1.198v8.66a1.199 1.199 0 01-1.206 1.198h-.001a1.2 1.2 0 01-1.207-1.198V6.087z" />
...
export const ArchiveBoxIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.03 1.123 0 1.131.094 1.976 1.057 1.976 2.192V7.5m-9 7.5h15m-15 0a9 9 0 019-9h0a9 9 0 019 9m-9 9v-9m0 9H3.75a1.5 1.5 0 01-1.5-1.5V12a1.5 1.5 0 011.5-1.5h15a1.5 1.5 0 011.5 1.5v5.25a1.5 1.5 0 01-1.5 1.5H12m-9 0v-9" />
  </svg>
);
